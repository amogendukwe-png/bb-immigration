...
export const ExitIneligible: React.FC = () => {
  ...
  return (
    <div className="space-y-8" id="exit-page">
      <h1 className="text-3xl md:text-4xl font-bold text-[var(--color-red-00)]">{message}</h1>
      <p className="text-xl leading-relaxed max-w-2xl">{guidance}</p>
      
      <div className="pt-8 border-t border-[var(--color-black-00)] mt-12">
        ...
        <div className="bg-[var(--color-white-00)] p-6 border-l-4 border-[var(--color-mid-grey-00)]">
          <p className="font-bold">Immigration Department</p>
          <p>Careenage House, The Wharf</p>
          <p>Bridgetown, Barbados</p>
          <p className="mt-2 text-[var(--color-teal-00)] font-medium underline cursor-pointer">immigration.dept@barbados.gov.bb</p>
        </div>
      </div>
    </div>
  );
